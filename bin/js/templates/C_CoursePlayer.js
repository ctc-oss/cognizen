...
function C_CoursePlayer(_course) {
    ...
    function receiveCoursePath(){
         ...
         if(isImport){
            ...
            coursePath = [window.location.protocol, '//', window.location.host, '/hosted/import/', course].join('') +"/"+ importHref;
    ...
    function updateTOCImport(_data){
        console.log(coursePath);
        ...
        msg += '<div class="C_LMSCourseTitle">'+importTitle+'<span class="C_CloseCourseButton">X</span></div>';
        ...
        // for(var i = 0; i < module_arr.length; i++){ 
            ...
            msg += '<div class="C_LMSLessonName">' + importTitle+ '</div>';
           ...
           // msg += '<img class="C_LMSLessonStatus" src="./css/images/lms_status_' + lessonStatus.completion + '.png" title="status: ' + lessonStatus.completion + '" alt="lesson status ' + lessonStatus.completion + '">';
            msg += '<div class="C_LMSLaunchButton" title="'+ importTitle +'" data-fancybox-type="iframe" href="' + coursePath + '" data-path="'+ coursePath +'">launch</div>';
            msg += '</div>';
        // }
