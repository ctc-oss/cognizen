...

{
   ...
   if (name == "cmi.learner_name")

   {

          getValueReturn = api.GetValue(name);
...
function doLMSSetValue(name, value)
{
  initializeConversionTables();
   ...
   if ( elementRequestArr[0] == "cmi" || elementRequestArr[0] == "adl")
   {
...
function findApiFrames(parent) {
	if(parent.document.API_1484_11 != null) {
		return parent.document.API_1484_11;
	}
...
function findAPI(win)
{
   while ( (win.document.API_1484_11 == null)&&(win.parent != null)&&(win.parent != win) )
   {
      findAPITries++;
...
//         alert("Error finding API -- too deeply nested. 1.3");
      ...
      win = win.parent;
   	...
   	if(win.document.API_1484_11 != null) {
		return win.document.API_1484_11;
	} else {
		return findApiFrames(win);
	}
...
function APIsearch(searchIn) //ERICA   add this entire method
{ // Search window and child frames for "API" object
   if (searchIn.API_1484_11 != null) return searchIn.API_1484_11;
...
function locateAPI() { // Search window and opener for "API" object     //ERICA   add this entire method
   var theResult = APIsearch(this.top);
   if (theResult == null) {
      if (typeof(this.opener) != "undefined") {
         if (this.opener != null) theResult = APIsearch(this.opener.top);
      }
   }
...
function convertCore(name,arrayOfComponents)
{
   ...
   if ( updatedName == "cmi.completion_status" )
   {
      if ( statusRequest == null )
      {
         // The cmi.completion_status was never set by the SCO.  
